...
def app():
    ...
    st.write('**Step 3**: Once you have logged-in,go to "QUERY CSV" page ,upload the CSV file which you want to query.')
    ...
    st.write('2. **Query Page**: Upload PDF& CSV files for AI-based processing and ask questions.')
